...
<div class="userList" style="width: 95%;margin: 0 auto 0 auto">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
        <?php if(is_array($adminList)): $i = 0; $__LIST__ = $adminList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$u): $mod = ($i % 2 );++$i;?><tr data-row-id="<?php echo ($u["id"]); ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="userInfoAdd" action="<?php echo U('Rbac/addAdmin');?>">
    ...
    $(function(){
        ...
        $(".userList tbody tr .delete").click(function(){
            ...
            if(confirm("确定删除用户"+username+"吗?")){
                $.post("<?php echo U('Rbac/deleteAdmin');?>",{id:id},function(data){
                    alert(data.msg);
                    location.reload();
                },"JSON")
            }else{
