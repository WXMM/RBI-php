...
<section class="content">
    ...
    <a style="display: none" href="thicknessOriginData.html?id=<?php echo ($srcId); ?>" target="content"><span id="targetSpan" data-data="<?php echo ($srcId); ?>"></span></a>
    <div class="content_text">
        <iframe name="content" src="thicknessOriginDataList.html" frameborder="0"  scrolling="yes" width="100%" height="100%"></iframe>
    </div>
</section>
</body>
...
<script>
    $(function(){
        $('title', window.parent.document).html("测厚原始记录");
        //        初始化高度
...
//        属性菜单栏展开收缩
        ...
        var url="thicknessOriginDataList.html?";
        $(function(){
