...
<section class="content">
    ...
    <a style="display: none" href="MaintenanceRecordlist.html?id=<?php echo ($srcId); ?>" target="content"><span id="targetSpan" data-data="<?php echo ($srcId); ?>"></span></a>
...
<script>
    $(function(){
        $('title', window.parent.document).html("维修记录管理");
        //        初始化高度
