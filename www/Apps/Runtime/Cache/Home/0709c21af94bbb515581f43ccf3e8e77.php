...
<head>
    ...
    <style>
        ...
        div.fold{  width: 14px;  float: left;  cursor: pointer; border-right:1px solid #c5c3cc;background-color: #f1eff8; }
...
<section class="content">
    ...
    <a style="display: none" href="DailyManagementRecordList.html?id=<?php echo ($srcId); ?>" target="content"><span id="targetSpan" data-data="<?php echo ($srcId); ?>"></span></a>
...
<script>
    $(function(){
        $('title', window.parent.document).html("日常维护管理");
