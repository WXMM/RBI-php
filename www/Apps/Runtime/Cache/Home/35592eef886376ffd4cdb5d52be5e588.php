...
<div id="bodySize" style="overflow: auto;width: 100%;padding-bottom: 50px">
    ...
    <div id="mapPosition">
        <div style="width: 640px;height: 480px">
            <ul id="bubblemenu">
                <?php if(is_array($GisData)): $k = 0; $__LIST__ = $GisData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Gi): $mod = ($k % 2 );++$k;?><li  data-X="<?php echo ($Gi["positionX"]); ?>" data-Y="<?php echo ($Gi["positionY"]); ?>" data-alert="<?php echo ($Gi["alertRecordId"]); ?>">
                        <span class="glyphicon glyphicon-map-marker"></span>
                        <a href="twoLevelMap.html?id=<?php echo ($Gi["id"]); ?>" style="filter:alpha(opacity=50);background:#ffffff;"><strong><?php echo ($Gi["plantName"]); ?> </strong></a>
                        <div>
            ...
            <img src="/www/Public/Home/img/gisMap/chinaMap.jpg"  alt="中国地图" />
        </div>
    </div>
</div>
<!-- 新增位置模态框（Modal） -->
