...
<section class="content">
    ...
    <div class="content_text">
        <iframe name="content" src="AlertRecordList.html" frameborder="0"  scrolling="yes" width="100%" height="100%"></iframe>
    </div>
</section>
</body>
...
<script>
    $(function(){
        $('title', window.parent.document).html("报警信息管理");
        //        初始化高度
