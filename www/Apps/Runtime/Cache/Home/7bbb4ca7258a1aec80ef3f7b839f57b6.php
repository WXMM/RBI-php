...
<section class="content">
    ...
    <a style="display: none" href="tankInfoDetail.html?id=<?php echo ($srcId); ?>" target="content"><span id="targetSpan" data-data="<?php echo ($srcId); ?>"></span></a>
    <div class="content_text">
        <iframe name="content" src="tankInfoList.html" frameborder="0"  scrolling="yes" width="100%" height="100%"></iframe>
    </div>
</section>
</body>
...
<script>
    $(function(){
        $('title', window.parent.document).html("常压储罐基本信息");
//        初始化高度
