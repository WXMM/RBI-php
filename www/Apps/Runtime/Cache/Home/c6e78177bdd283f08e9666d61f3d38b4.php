...
<div id="bodySize" style="overflow: auto;width: 100%;padding-bottom: 50px">
    <div id="breadcrumb">
        <ol class="breadcrumb" style="background-color: transparent;float: left; height: 30px;width: 100%">
            ...
            <li><a href="twoLevelMap.html?id=<?php echo ($GisDataFa["pid"]); ?>"><?php echo ($GisDataFa["gPlantName"]); ?></a></li>
        ...
        <div style="width: 640px;height: 480px">
            <ul id="bubblemenu">
                <?php if(is_array($GisData)): $i = 0; $__LIST__ = $GisData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Gi): $mod = ($i % 2 );++$i;?><li  data-X="<?php echo ($Gi["positionX"]); ?>" data-Y="<?php echo ($Gi["positionY"]); ?>" data-alert="<?php echo ($Gi["alertRecordId"]); ?>">
                        ...
                        <a style="filter:alpha(opacity=50);background:#ffffff;"><strong><?php echo ($Gi["plantName"]); ?></strong></a>
                        <div>
                    ...
                    <!--<span class="tooltip-item"><?php echo ($Gi["plantName"]); ?></span>-->
                    <!--<span class="tooltip-content">Did you know that you can travel from A to B?</span>-->
                    <!--</div>-->
                    <!--<span class="glyphicon glyphicon-map-marker"></span>--><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
                ...
                <div class="modal-body">
                    <div class="input-group">
                        ...
                        <select  type="text" name="plantName" class="form-control" placeholder="位置的名称">
                            <?php if(is_array($Plant)): $i = 0; $__LIST__ = $Plant;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($wo["plantNO"]); ?>"><?php echo ($wo["plantNO"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" id="addNewMapForm" action="<?php echo U('Visualization/upload');?>" method="post" style="padding: 20px">
                ...
                <div class="input-group" style="display: none">
                    ...
                    <input type="text" class="form-control" name="subMapName" value="<?php echo ($GisDataFa["plantName"]); ?>" />
                </div>
                <br>
