...
<section class="content">
    ...
    <a style="display: none" href="InspectRecordList.html?id=<?php echo ($srcId); ?>" target="content"><span id="targetSpan" data-data="<?php echo ($srcId); ?>"></span></a>
...
<script>
    $(function(){
        $('title', window.parent.document).html("检验记录管理");
        //        初始化高度
