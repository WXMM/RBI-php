...
<section class="content">
    ...
    <a style="display: none" href="thicknessData.html?Index=<?php echo ($srcId); ?>" target="content"><span id="targetSpan" data-data="<?php echo ($srcId); ?>"></span></a>
    <div class="content_text">
        <iframe name="content" src="thicknessDataList.html" frameborder="0"  scrolling="yes" width="100%" height="100%"></iframe>
    </div>
</section>
</body>
...
<script>
    $(function(){
        $('title', window.parent.document).html("定点测厚管理");
        //        初始化高度
        ...
        var url="thicknessDataList.html?";
        $(function(){
